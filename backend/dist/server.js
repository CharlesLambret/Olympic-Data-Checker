...
const insertindex_1 = __importDefault(require("./insertiondata/insertindex"));
...
app.use(classicuser_1.default, indexusers_1.default, indexolympics_1.default, insertindex_1.default);
app.listen(3000, () => {
